        ...
        if (props.LandUse != 'Urban'){
            ...
            popupContent = L.Util.template('<div class="popup-title"><p>Typical Cross Sections</p></div>'+
                '<div class="popup-content">'+
                    ...
                    '<a href="{img}" target="_blank">Click Here for a ROW Cross-Section Diagram</a>'+
                '</div>', props);
            return popupContent;
        }
    }
    ...
    function createPopUps(feature, layer){
        ...
        switch(name){
            ...
            case "planType":
                ...
                break;
            case "tip-point":
                popupContent = L.Util.template('<div class="popup-title"><p>New Jersey TIP<br>Bridge/Intersections</p></div><div class="popup-content"><p><span class="popup-content-bold">Project Name:</span> {PROJECTNAM}</p><p><span class="popup-content-bold">Type:</span> {TYPE}</p><p><span class="popup-content-bold">Program:</span> {PROGRAM}</p><a href="{REPORT}" target="_blank">Click Here for More Info</a></div>', props);
                break;
            case "tip-roads":
                popupContent = L.Util.template('<div class="popup-title"><p>New Jersey TIP<br>Roadways</p></div><div class="popup-content"><p><span class="popup-content-bold">Project Name:</span> {PROJECT}</p><p><span class="popup-content-bold">Program:</span> {PROGRAM}</p><p><span class="popup-content-bold">Description:</span> {DESCRIPTIO}</p><a href="{DETAIL}" target="_blank">Click Here for More Info</a></div>', props);
                break;
            case "burCoPubWorks":
