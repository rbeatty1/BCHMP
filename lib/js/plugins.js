...
function createPopUps(feature, layer){
    ...
    switch(name){
        ...
        case "burCoPubWorks":
            ...
            break;
        case "congestion-lrp":
            popupContent = L.Util.template('<div class="popup-title"><p>Congestion Management Strategies for 2040 LRP</p></div><div class="popup-content"><p>Name:</p></div>', props);
            break;
        case "cmp-inventory":
            popupContent = L.Util.template('<div class="popup-title"><p>PLACEHOLDER</p></div><div class="popup-content"><p>PLACEHOLDER: stuff</p></div>', props);
            break;
        case "capacity":
