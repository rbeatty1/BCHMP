    ...
    switch(cnt.length){
        ...
        case 4:
            popupContent = L.Util.template('<div class="popup-title">'+
                '<p>Congestion Management Strategies</p></div>'+
                '<div class="popup-content-congest">'+
                    '<img width="25%" src="'+cnt[0]['value']+'"/>'+
                    '<img width="25%" src="'+cnt[1]['value']+'"/>'+
                    '<img width="25%" src="'+cnt[2]['value']+'"/>'+
                    '<img width="25%" src="'+cnt[3]['value']+'"/>'+
                '</div>');
            break;
        case 5:
            popupContent = L.Util.template('<div class="popup-title">'+
                '<p>Congestion Management Strategies</p></div>'+
                '<div class="popup-content-congest">'+
                    '<img width="20%" src="'+cnt[0]['value']+'"/>'+
                    '<img width="20%" src="'+cnt[1]['value']+'"/>'+
                    '<img width="20%" src="'+cnt[2]['value']+'"/>'+
                    '<img width="20%" src="'+cnt[3]['value']+'"/>'+
                    '<img width="20%" src="'+cnt[4]['value']+'"/>'+
                '</div>');
            break;
        default:
            popupContent = L.Util.template('<div class="popup-title">'+
