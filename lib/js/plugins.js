...
function createPopUps(feature, layer){
    /*
    NEED TO BE ABLE TO PASS A CHECKBOX ID TO THIS FUNCTION SO I 
    CAN MATCH POP UP TEMPLATES AND BIND POP UPS APPROPRIATELY
    */
    var popupContent;
    ...
    switch(name){
        ...
        case "bizCenters":
        case "freightCenters":
            popupContent = L.Util.template('<p>test one</p>');
            break;
        default:
            popupContent = L.Util.template('<p>test two</p>');
    }
                        ...
                        if (allLayers[z].layers[y].qry != undefined){
                            lyr = L.esri.featureLayer({
                                ...
                                onEachFeature: function(feature, layer){
                                    /* 
                                    HOW DO I GET THE CHECKBOX ID ASSOCIATED WITH THIS LAYER
                                    */
