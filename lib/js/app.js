...
$(document).ready(function(){
    ...
    $('.bchmp-panel').on('click', function(){
        ...
        if ($("#"+clickTarget).children(".panel-title").children(".title").text().toLowerCase() ==='right-of-way'){
            activePane = "row";
        }
        else{
        ...
        if($("#"+clickTarget).hasClass('panel-inactive')){
            ...
            $(".panel-active").attr("class", "panel-active col-lg-9 col-sm-9");
            $(".panel-inactive").attr("class", "panel-inactive col-lg-1 col-sm-1");
